...
def test_run_schema_drift_cli_passes_for_claude(tmp_path: Path, claude_root: Path) -> None:
...
@pytest.mark.provider_claude
def test_run_schema_drift_cli_errors_for_unknown_provider(tmp_path: Path, claude_root: Path) -> None:
    repo_root = claude_root.parents[3]
