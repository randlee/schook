...
| `SC-LOG-S2` / Observability Phase 1 | In review | layered config foundation | `DEF-010`, `DEF-011` | `SC-LOG-S1` | `sc-hooks-cli` config loading, requirements/architecture docs, config tests; code is merge-forwarded into the `SC-LOG-S3` branch for PR #91, while PR #90 remains the official S2 merge record |
