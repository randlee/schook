...
| `SC-LOG-S5` / Observability Phase 4 | In review | full audit debug profile and redaction controls | `DEF-013`, `DEF-014`, `DEF-015` | `SC-LOG-S4` | redaction policy, payload-capture gates, debug-profile tests |
