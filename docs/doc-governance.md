...
6. Supporting docs must reference the requirement IDs or gap IDs they implement when they describe release-facing behavior.
...
- contract docs and consumer docs reference the requirement IDs or gap IDs they implement
