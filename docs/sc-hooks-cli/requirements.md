...
| `REQ-SHK-CLI-010` | Planned | The CLI crate shall complete the remaining audit-phase ownership for debug-profile expansion, redaction policy enforcement, retention pruning, and load-hardening without introducing a public sink-extension API. | `REQ-SHK-DEF-013`, `REQ-SHK-DEF-014`, `REQ-SHK-DEF-015`, `REQ-SHK-DEF-016` | `sc-hooks-cli/src/observability.rs`, future audit tests |
