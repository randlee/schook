...
| `REQ-SHK-CLI-009` | Planned | The CLI crate shall own full-audit sink orchestration, retention pruning, and degraded-path handling without affecting hook execution; this audit-trail work remains distinct from the existing static `sc-hooks audit` command. | `REQ-SHK-DEF-012`, `REQ-SHK-DEF-013`, `REQ-SHK-DEF-014`, `REQ-SHK-DEF-015`, `REQ-SHK-DEF-016`, `REQ-SHK-DEF-017`, `REQ-SHK-DEF-019` | `sc-hooks-cli/src/observability.rs`, `sc-hooks-cli/src/dispatch.rs`, future audit tests |
