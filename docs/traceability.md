...
| DEF-009 | planned | `docs/requirements.md`, `docs/phase-observability-plan.md`, `docs/project-plan.md` | `SC-LOG-S6` requires long-term integration coverage forcing observability emit and audit append failure while preserving hook exits and asserting degraded fallback text | `SC-LOG-S6` |
...
| DEF-017a | planned | `docs/observability-contract.md`, `docs/phase-observability-plan.md`, `docs/project-plan.md` | phase exit requires degraded-path integration coverage proving failed pre-dispatch audit persistence falls back to stderr without changing hook outcomes | observability phase |
