...
| TMO-004 | gap | `sc-hooks-cli/src/timeout.rs`, `sc-hooks-cli/src/audit.rs`, `sc-hooks-sdk/src/manifest.rs` | timeout tests only prove host side | GAP-002 |
...
| CLI-007 | gap | `sc-hooks-test/src/compliance.rs`, `sc-hooks-cli/src/testing.rs`, `sc-hooks-cli/src/main.rs` | minimal compliance tests only | GAP-001 |
...
| TST-007 | gap | `sc-hooks-test/src/compliance.rs`, `sc-hooks-cli/src/testing.rs` | current harness tests | GAP-001 |
