...
| BND-002 | implemented | `plugins/*/Cargo.toml`, README, architecture docs | release-facing docs and plugin metadata agree that the four runtime implementation source crates remain source-owned rather than bundled/preinstalled, while the nine remaining crates stay scaffold/reference | |
