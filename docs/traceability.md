...
| DEF-019 | implemented | `docs/requirements.md`, `docs/architecture.md`, `docs/project-plan.md`, `crates/sc-hooks-cli/src/install.rs`, `README.md`, `USAGE.md`, `PUBLISHING.md` | naming cleanup landed in `SC-LOG-S1`; `P.8` added the local install/cutover `hooks` wrapper and aligned the operator docs to the real alias-install behavior | |
