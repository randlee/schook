...
| HKR-004 | partially implemented | `plugins/atm-session-lifecycle`, `plugins/atm-bash-identity`, `plugins/gate-agent-spawns`, `docs/project-plan.md`, `docs/requirements.md` | session lifecycle, bash identity, and spawn gate tests plus branch-level phase status records | HKR-002, HKR-003 |
