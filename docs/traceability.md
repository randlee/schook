...
| HKR-006 | implemented | `docs/plan-phase-O.md`, `docs/phase-O/sprint-O3.md`, `docs/phase-O/sprint-O4.md`, `docs/phase-O/sprint-O5.md`, `crates/sc-hooks-cli/src/main.rs`, `crates/sc-hooks-core/src/normalization.rs`, `plugins/agent-session-foundation/src/lib.rs`, `crates/sc-hooks-cli/tests/codex_runtime_parity.rs`, `crates/sc-hooks-cli/tests/gemini_runtime_parity.rs` | `O.4` and `O.5` prove the approved Codex and Gemini surfaces now enter the generic runtime through the sealed normalization boundary; Cursor stays deferred under `HKR-007` | Codex and Gemini runtime parity implemented on the approved provider surfaces; Cursor remains deferred. |
...
| HKR-010 | implemented | `docs/plan-phase-O.md`, `docs/phase-O/sprint-O4.md`, `docs/phase-O/sprint-O5.md`, `docs/phase-O/sprint-O6.md`, `crates/sc-hooks-cli/src/main.rs`, `crates/sc-hooks-core/src/normalization.rs`, `plugins/atm-extension/src/lib.rs`, `plugins/agent-spawn-gates/src/lib.rs`, `plugins/tool-output-gates/src/lib.rs`, `crates/sc-hooks-cli/tests/codex_runtime_parity.rs`, `crates/sc-hooks-cli/tests/gemini_runtime_parity.rs` | `O.4` and `O.5` prove Codex and Gemini preserve retryable normalization failures with `recovery_hint` and drive the shared spawn/tool/ATM runtime path on the approved provider surfaces | Codex and Gemini parity implemented on the approved provider surfaces. |
