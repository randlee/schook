...
| DEF-013 | planned | `docs/phase-observability-plan.md`, `docs/project-plan.md` | phase entry requires frozen lean/debug field sets and profile-selection tests | lean field set is implemented in `SC-LOG-S4`; debug field completion and profile-selection closure remain `SC-LOG-S5` scope |
