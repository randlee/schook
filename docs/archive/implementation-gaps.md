...
>
> This file is retained as a completed planning artifact. Current control-doc
> ownership lives in `docs/requirements.md`, `docs/architecture.md`,
> `docs/project-plan.md`, and `docs/traceability.md`.
