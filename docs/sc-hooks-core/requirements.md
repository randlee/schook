...
| `REQ-SHK-CORE-005` | Deferred | The core crate may add shared typed invocation or correlation primitives for the planned audit phase, but shall remain sink-agnostic and shall not own logging policy. | `REQ-SHK-DEF-012`, `REQ-SHK-DEF-016`, `REQ-SHK-DEF-017` | future shared event-model files under `sc-hooks-core/src/` |
